# =================================================
# CoreSlap.ps1 – Core-parking & Game Bar Utility
# =================================================

Clear-Host

# --- Returns hashtable with .Status (string) and .Value (int) ---
...
# --- Advanced menu that returns to main menu on 'X' ---
...
function Show-MainMenu {
    ...
    Write-Host CoreSlap : Core Parking Utility 1.0
	Write-Host Jay Anderson 6.27.25 - FullDuplexTech.com
