...
function Set-X3DCoreParking {
    ...
    Write-Host 'V-Cache CCD (CCD0): Cores ' $x3dStatus.CCD0Cores
    Write-Host 'Non-V-Cache CCD (CCD1): Cores ' $x3dStatus.CCD1Cores
...
function Show-MainMenu {
    ...
    Write-Host CoreSlap : Core Parking Utility 1.3
